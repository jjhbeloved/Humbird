...
public final class TFTPDataPacket extends TFTPPacket
{
    ...
    {
        super(org.humbird.soa.common.net.tftp.TFTPPacket.DATA, destination, port);
    ...
    {
        super(org.humbird.soa.common.net.tftp.TFTPPacket.DATA, datagram.getAddress(), datagram.getPort());
