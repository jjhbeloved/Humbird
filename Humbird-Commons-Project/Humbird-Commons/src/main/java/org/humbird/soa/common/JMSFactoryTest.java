package org.humbird.soa.common;

import org.humbird.soa.common.jms.JMSFactory;
...
//      private static final String SAP_NAMING_PROVIDER_URL = "t3s://10.1.249.84:8012"; // Set the <server_host> and the <p4_port>
    ...
    public static void newProducerTest() throws NamingException, JMSException {
...
//        /****/
    ...
    public static void newConsumerTest() throws NamingException, JMSException {
