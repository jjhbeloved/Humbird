...
package org.humbird.soa.common.net.echo;

import org.humbird.soa.common.net.discard.DiscardUDPClient;
 ...
 * with {@link org.humbird.soa.common.net.DatagramSocketClient#open  open }
 ...
 * <p>
 * <p>
 * @see org.humbird.soa.common.net.echo.EchoTCPClient
 * @see org.humbird.soa.common.net.discard.DiscardUDPClient
 ***/
...
public final class EchoUDPClient extends DiscardUDPClient
{
     ...
     * @exception java.io.IOException If an error occurs during the datagram send
     *     operation.
     ***/
    @Override
     ...
     * @exception java.io.IOException If an error occurs while receiving the data.
     ***/
