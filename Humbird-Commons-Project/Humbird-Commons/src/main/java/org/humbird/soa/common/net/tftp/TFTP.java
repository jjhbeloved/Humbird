...
package org.humbird.soa.common.net.tftp;

import org.humbird.soa.common.net.DatagramSocketClient;
 ...
 * the {@link org.humbird.soa.common.net.DatagramSocketClient#open  open() },
 * and {@link org.humbird.soa.common.net.DatagramSocketClient#close  close() },
 * methods. Additionally,the a
 * {@link org.humbird.soa.common.net.DatagramSocketClient#setDefaultTimeout setDefaultTimeout() }
 ...
 * <p>
 * <p>
 * @see org.humbird.soa.common.net.DatagramSocketClient
 * @see org.humbird.soa.common.net.tftp.TFTPPacket
 * @see org.humbird.soa.common.net.tftp.TFTPPacketException
 * @see org.humbird.soa.common.net.tftp.TFTPClient
 ***/
...
public class TFTP extends DatagramSocketClient
{
     ...
     * @exception java.io.InterruptedIOException  If a socket timeout occurs.  The
     ...
     * @exception java.net.SocketException  If a socket timeout occurs.  The
     *       Java documentation claims an InterruptedIOException is thrown
     *       on a DatagramSocket timeout, but in practice we find a
     *       SocketException is thrown.  You should catch both to be safe.
     * @exception java.io.IOException  If some other I/O error occurs.
     * @exception org.humbird.soa.common.net.tftp.TFTPPacketException If an invalid TFTP packet is received.
     ***/
     ...
     * @exception java.io.IOException  If some  I/O error occurs.
     ***/
