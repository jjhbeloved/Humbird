...
package org.humbird.soa.common.net.smtp;
 ...
 * {@link org.humbird.soa.common.net.smtp.SMTP#getReplyCode  getReplyCode } after
 ...
 * {@link org.humbird.soa.common.net.smtp.SMTPReply#SERVICE_NOT_AVAILABLE SMTPReply.SERVICE_NOT_AVAILABLE }
 *  response to a command.
 * When that occurs, the method encountering that reply will throw
 * an {@link org.humbird.soa.common.net.smtp.SMTPConnectionClosedException}
 * .
 ...
 * {@link org.humbird.soa.common.net.smtp.SMTPConnectionClosedException}
 ...
 * {@link org.humbird.soa.common.net.smtp.SMTP#getReplyCode  getReplyCode },
 * {@link org.humbird.soa.common.net.smtp.SMTP#getReplyString  getReplyString },
 * and
 * {@link org.humbird.soa.common.net.smtp.SMTP#getReplyStrings getReplyStrings}.
 * <p>
 ...
 * <p>
 * <p>
 * @see org.humbird.soa.common.net.smtp.SMTP
 * @see org.humbird.soa.common.net.smtp.SimpleSMTPHeader
 * @see org.humbird.soa.common.net.smtp.RelayPath
 * @see org.humbird.soa.common.net.smtp.SMTPConnectionClosedException
...
public class SMTPClient extends SMTP
{
     ...
     * @exception org.humbird.soa.common.net.smtp.SMTPConnectionClosedException
    ...
    {
        return org.humbird.soa.common.net.smtp.SMTPReply.isPositiveCompletion(getReply());
    }
    ...
    {
        return org.humbird.soa.common.net.smtp.SMTPReply.isPositiveCompletion(helo(hostname));
    }
    ...
    public boolean login() throws IOException
    {
        ...
        return org.humbird.soa.common.net.smtp.SMTPReply.isPositiveCompletion(helo(name));
    }
     ...
     *      command to the server or receiving a reply from the server.
     ***/
    public boolean setSender(org.humbird.soa.common.net.smtp.RelayPath path) throws IOException
    {
        return org.humbird.soa.common.net.smtp.SMTPReply.isPositiveCompletion(mail(path.toString()));
    }
    ...
    {
        return org.humbird.soa.common.net.smtp.SMTPReply.isPositiveCompletion(mail("<" + address + ">"));
    }
    ...
    {
        return org.humbird.soa.common.net.smtp.SMTPReply.isPositiveCompletion(rcpt(path.toString()));
    }
    ...
    {
        return org.humbird.soa.common.net.smtp.SMTPReply.isPositiveCompletion(rcpt("<" + address + ">"));
    }
     ...
     * {@link org.humbird.soa.common.net.smtp.SimpleSMTPHeader}
    ...
    {
        if (!org.humbird.soa.common.net.smtp.SMTPReply.isPositiveIntermediate(data())) {
            return null;
        }
    ...
    {
        return org.humbird.soa.common.net.smtp.SMTPReply.isPositiveCompletion(quit());
    }
    ...
    {
        return org.humbird.soa.common.net.smtp.SMTPReply.isPositiveCompletion(rset());
    }
    ...
    public boolean verify(String username) throws IOException
    {
        ...
        return (result == org.humbird.soa.common.net.smtp.SMTPReply.ACTION_OK ||
                result == org.humbird.soa.common.net.smtp.SMTPReply.USER_NOT_LOCAL_WILL_FORWARD);
    }
    ...
    {
        if (org.humbird.soa.common.net.smtp.SMTPReply.isPositiveCompletion(help())) {
    ...
    {
        if (org.humbird.soa.common.net.smtp.SMTPReply.isPositiveCompletion(help(command))) {
            return getReplyString();
        }
        return null;
    }
