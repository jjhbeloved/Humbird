 ...
 * @see org.humbird.soa.common.net.ftp.FTPFileEntryParser FTPFileEntryParser (for usage instructions)
 */
public class UnixFTPEntryParser extends ConfigurableFTPFileEntryParserImpl
{
     ...
     * <code>UnixFTPEntryParser(FTPClientConfigX)</code>.
     * Steve Cohen - 2005-04-17
     */
    public static final FTPClientConfigX NUMERIC_DATE_CONFIG =
        new FTPClientConfigX(
                FTPClientConfigX.SYST_UNIX,
                NUMERIC_DATE_FORMAT,
                null, null, null, null);
     ...
     *
     * @param config The {@link org.humbird.soa.common.net.ftp.FTPClientConfigX configuration} object used to
     ...
     * @since 1.4
     */
    public UnixFTPEntryParser(FTPClientConfigX config)
    {
        super(REGEX);
        configure(config);
    }
...
//    @Override
     ...
     * instantiated without a {@link  org.humbird.soa.common.net.ftp.FTPClientConfigX  FTPClientConfigX}
     * parameter being specified.
     * @return the default configuration for this parser.
     */
    @Override
    protected FTPClientConfigX getDefaultConfiguration() {
        return new FTPClientConfigX(
                FTPClientConfigX.SYST_UNIX,
                DEFAULT_DATE_FORMAT,
