...
public final class TFTPAckPacket extends org.humbird.soa.common.net.tftp.TFTPPacket
{
    ...
    {
        super(org.humbird.soa.common.net.tftp.TFTPPacket.ACKNOWLEDGEMENT, destination, port);
