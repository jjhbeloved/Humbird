...
public final class FileUtil {
     ...
     * @throws java.io.IOException If an I/O error occurs during copy or delete operations.
     */
    public static boolean renameFileUsingCopy(File from, File to) throws IOException {
        ...
        copyFile(from, to);
        if (!deleteFile(from)) {
            LOG.debug("Renaming file from '" + from + "' to '" + to + "' failed: Cannot delete file '" + from + "' after copy succeeded");
        }
     ...
     * @throws java.io.IOException is thrown if error creating the new file
     */
