...
package org.humbird.soa.common.net.nntp;

import org.humbird.soa.common.net.MalformedServerReplyException;
import org.humbird.soa.common.net.io.DotTerminatedMessageReader;
import org.humbird.soa.common.net.io.DotTerminatedMessageWriter;
import org.humbird.soa.common.net.io.Util;
 ...
 * {@link org.humbird.soa.common.net.nntp.NNTP#disconnect  disconnect() }
 * after you're completely finished interacting with the server.
 * Remember that the
 * {@link org.humbird.soa.common.net.nntp.NNTP#isAllowedToPost isAllowedToPost()}
 *  method is defined in
 * {@link org.humbird.soa.common.net.nntp.NNTP}.
 * <p>
 ...
 * {@link org.humbird.soa.common.net.nntp.NNTPReply#SERVICE_DISCONTINUED NNTPReply.SERVICE_DISCONTINUED }
 *  response to a command.
 * When that occurs, the NNTP class method encountering that reply will throw
 * an {@link org.humbird.soa.common.net.nntp.NNTPConnectionClosedException}
 * .
 ...
 * {@link org.humbird.soa.common.net.nntp.NNTPConnectionClosedException}
 * , you must disconnect the connection with
 * {@link org.humbird.soa.common.net.nntp.NNTP#disconnect  disconnect() }
 *  to properly clean up the
 * system resources used by NNTP.  Before disconnecting, you may check the
 * last reply code and text with
 * {@link org.humbird.soa.common.net.nntp.NNTP#getReplyCode  getReplyCode } and
 * {@link org.humbird.soa.common.net.nntp.NNTP#getReplyString  getReplyString }.
 * <p>
 ...
 * @author Rory Winston
 * @author Ted Wise
 * @see org.humbird.soa.common.net.nntp.NNTP
 * @see org.humbird.soa.common.net.nntp.NNTPConnectionClosedException
...
public class NNTPClient extends NNTP
{
     ...
     *
     * @throws org.humbird.soa.common.net.MalformedServerReplyException
     */
     ...
     * @return the parsed {@link org.humbird.soa.common.net.nntp.Article}, if unparseable then isDummy()
     * will be true, and the subject will contain the raw info.
     * @since 3.0
     */
    static org.humbird.soa.common.net.nntp.Article __parseArticleEntry(String line) {
        // Extract the article information
        // Mandatory format (from NNTP RFC 2980) is :
        // articleNumber\tSubject\tAuthor\tDate\tID\tReference(s)\tByte Count\tLine Count

        org.humbird.soa.common.net.nntp.Article article = new org.humbird.soa.common.net.nntp.Article();
    ...
    throws IOException
    {
        if (articleId != null)
        {
            if (!org.humbird.soa.common.net.nntp.NNTPReply.isPositiveCompletion(sendCommand(command, articleId))) {
                return null;
            }
        }
        else
        {
            if (!org.humbird.soa.common.net.nntp.NNTPReply.isPositiveCompletion(sendCommand(command))) {
                return null;
            }
        }
     ...
     * @exception org.humbird.soa.common.net.nntp.NNTPConnectionClosedException
     ...
     * Note: the return can be cast to a {@link java.io.BufferedReader}
     */
    ...
    throws IOException
    {
        if (!org.humbird.soa.common.net.nntp.NNTPReply.isPositiveCompletion(group(newsgroup))) {
            return false;
        }
    ...
    {
        if (!org.humbird.soa.common.net.nntp.NNTPReply.isInformational(help())) {
            return null;
        }
    ...
    {
        if (!org.humbird.soa.common.net.nntp.NNTPReply.isPositiveCompletion(sendCommand("LIST", "OVERVIEW.FMT"))){
            return null;
        }
    ...
    {
        if (articleId != null) {
            if (!org.humbird.soa.common.net.nntp.NNTPReply.isPositiveCompletion(stat(articleId))) {
                return false;
            }
        } else {
            if (!org.humbird.soa.common.net.nntp.NNTPReply.isPositiveCompletion(stat())) {
                return false;
            }
        }
    ...
    throws IOException
    {
        if (!org.humbird.soa.common.net.nntp.NNTPReply.isPositiveCompletion(stat(articleNumber))) {
            return false;
        }
    ...
    throws IOException
    {
        if (!org.humbird.soa.common.net.nntp.NNTPReply.isPositiveCompletion(last())) {
            return false;
        }
    ...
    {
        if (!org.humbird.soa.common.net.nntp.NNTPReply.isPositiveCompletion(next())) {
            return false;
        }
    ...
    {
        if (!org.humbird.soa.common.net.nntp.NNTPReply.isPositiveCompletion(list())) {
            return null;
        }
    ...
    {
        if(!org.humbird.soa.common.net.nntp.NNTPReply.isPositiveCompletion(listActive(wildmat))) {
            return null;
        }
        return __readNewsgroupListing();
    }
     ...
     * @exception java.io.IOException  If an I/O error occurs while either sending a
     *      command to the server or receiving a reply from the server.
     * @see #iterateNewNewsgroups(org.humbird.soa.common.net.nntp.NewGroupsOrNewsQuery)
     * @see #iterateNewNewsgroupListing(org.humbird.soa.common.net.nntp.NewGroupsOrNewsQuery)
     ***/
    public NewsgroupInfo[] listNewNewsgroups(NewGroupsOrNewsQuery query)
    throws IOException
    {
        if (!org.humbird.soa.common.net.nntp.NNTPReply.isPositiveCompletion(newgroups(
     ...
     *      command to the server or receiving a reply from the server.
     *
     * @see #iterateNewNews(org.humbird.soa.common.net.nntp.NewGroupsOrNewsQuery)
     ***/
    public String[] listNewNews(NewGroupsOrNewsQuery query)
    throws IOException
    {
        if (!org.humbird.soa.common.net.nntp.NNTPReply.isPositiveCompletion(
    ...
    public Iterable<String> iterateNewNews(NewGroupsOrNewsQuery query) throws IOException {
        if (org.humbird.soa.common.net.nntp.NNTPReply.isPositiveCompletion(newnews(
    ...
    {
        return org.humbird.soa.common.net.nntp.NNTPReply.isPositiveCompletion(getReply());
    }
     ...
     * should check {@link org.humbird.soa.common.net.nntp.NNTP#isAllowedToPost isAllowedToPost() }
     ...
     * {@link org.humbird.soa.common.net.nntp.SimpleNNTPHeader}
    ...
    {
        if (!org.humbird.soa.common.net.nntp.NNTPReply.isPositiveIntermediate(post())) {
            return null;
        }
    ...
    {
        if (!org.humbird.soa.common.net.nntp.NNTPReply.isPositiveIntermediate(ihave(articleId))) {
            return null;
        }
    ...
    {
        return org.humbird.soa.common.net.nntp.NNTPReply.isPositiveCompletion(quit());
    }
        ...
        throws IOException
    {
        ...
        if (replyCode == org.humbird.soa.common.net.nntp.NNTPReply.MORE_AUTH_INFO_REQUIRED)
            {
                replyCode = authinfoPass(password);

                if (replyCode == org.humbird.soa.common.net.nntp.NNTPReply.AUTHENTICATION_ACCEPTED)
                    {
     ...
     *
     * See {@link org.humbird.soa.common.net.nntp.NNTP#xover}
    ...
    private BufferedReader __retrieveArticleInfo(String articleRange)
        throws IOException
    {
        if (!org.humbird.soa.common.net.nntp.NNTPReply.isPositiveCompletion(xover(articleRange))) {
            return null;
        }
     ...
     * @throws java.io.IOException if the command failed
     * @since 3.0
     */
     ...
     *
     * See {@link org.humbird.soa.common.net.nntp.NNTP#xhdr}
    ...
    /**
     * @deprecated 3.0 use {@link #selectArticle(long, org.humbird.soa.common.net.nntp.ArticleInfo)} instead
     */
    @Deprecated
    ...
    /**
     * @deprecated 3.0 use {@link #retrieveArticleHeader(long, org.humbird.soa.common.net.nntp.ArticleInfo)} instead
     */
    @Deprecated
    ...
    /**
     * @deprecated 3.0 use {@link #retrieveArticle(long, org.humbird.soa.common.net.nntp.ArticleInfo)} instead
     */
    @Deprecated
    ...
    /**
     * @deprecated 3.0 use {@link #retrieveArticleBody(long, org.humbird.soa.common.net.nntp.ArticleInfo)} instead
     */
    @Deprecated
    ...
    /**
     * @deprecated 3.0 use {@link #retrieveArticle(String, org.humbird.soa.common.net.nntp.ArticleInfo)} instead
     */
    @Deprecated
    ...
    /**
     * @deprecated 3.0 use {@link #retrieveArticleBody(String, org.humbird.soa.common.net.nntp.ArticleInfo)} instead
     */
    @Deprecated
    ...
    /**
     * @deprecated 3.0 use {@link #retrieveArticleHeader(String, org.humbird.soa.common.net.nntp.ArticleInfo)} instead
     */
    @Deprecated
    ...
    /**
     * @deprecated 3.0 use {@link #selectArticle(String, org.humbird.soa.common.net.nntp.ArticleInfo)} instead
     */
    @Deprecated
    ...
    /**
     * @deprecated 3.0 use {@link #selectArticle(org.humbird.soa.common.net.nntp.ArticleInfo)} instead
     */
    @Deprecated
    ...
    /**
     * @deprecated 3.0 use {@link #selectNextArticle(org.humbird.soa.common.net.nntp.ArticleInfo)} instead
     */
    @Deprecated
    ...
    /**
     * @deprecated 3.0 use {@link #selectPreviousArticle(org.humbird.soa.common.net.nntp.ArticleInfo)} instead
     */
    @Deprecated
