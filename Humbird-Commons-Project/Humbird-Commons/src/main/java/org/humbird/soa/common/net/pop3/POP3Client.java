...
package org.humbird.soa.common.net.pop3;
 ...
 * <p>
 * <p>
 * @see org.humbird.soa.common.net.pop3.POP3MessageInfo
 * @see org.humbird.soa.common.net.io.DotTerminatedMessageReader
...
public class POP3Client extends POP3
{
    ...
    {
        if (sendCommand(POP3Command.CAPA) == org.humbird.soa.common.net.pop3.POP3Reply.OK) {
            getAdditionalReply();
            return true;
        }
        return false;
     ...
     * {@link org.humbird.soa.common.net.pop3.POP3#AUTHORIZATION_STATE AUTHORIZATION_STATE }
     * .  After logging in, the client enters the
     * {@link org.humbird.soa.common.net.pop3.POP3#TRANSACTION_STATE TRANSACTION_STATE }
     * .
     * <p>
    ...
    public boolean login(String username, String password) throws IOException
    {
        ...
        if (sendCommand(POP3Command.USER, username) != org.humbird.soa.common.net.pop3.POP3Reply.OK) {
            return false;
        }

        if (sendCommand(POP3Command.PASS, password) != org.humbird.soa.common.net.pop3.POP3Reply.OK) {
            return false;
        }
     ...
     * {@link org.humbird.soa.common.net.pop3.POP3#getReplyString getReplyString }
    ...
    throws IOException, NoSuchAlgorithmException
    {
        ...
        if (sendCommand(POP3Command.APOP, buffer.toString()) != org.humbird.soa.common.net.pop3.POP3Reply.OK) {
            return false;
        }
     ...
     * you must call
     * {@link org.humbird.soa.common.net.pop3.POP3#disconnect  disconnect }.
     * A logout attempt is valid in any state.  If
     * the client is in the
     * {@link org.humbird.soa.common.net.pop3.POP3#TRANSACTION_STATE TRANSACTION_STATE }
     * , it enters the
     * {@link org.humbird.soa.common.net.pop3.POP3#UPDATE_STATE UPDATE_STATE }
    ...
    public boolean logout() throws IOException
    {
        ...
        return (_replyCode == org.humbird.soa.common.net.pop3.POP3Reply.OK);
    }
    ...
    {
        if (getState() == TRANSACTION_STATE) {
            return (sendCommand(POP3Command.NOOP) == org.humbird.soa.common.net.pop3.POP3Reply.OK);
        }
        return false;
    }
    ...
    public boolean deleteMessage(int messageId) throws IOException
    {
        if (getState() == TRANSACTION_STATE) {
            return (sendCommand(POP3Command.DELE, Integer.toString(messageId))
                    == org.humbird.soa.common.net.pop3.POP3Reply.OK);
        }
        return false;
    }
    ...
    {
        if (getState() == TRANSACTION_STATE) {
            return (sendCommand(POP3Command.RSET) == org.humbird.soa.common.net.pop3.POP3Reply.OK);
        }
        return false;
    }
    ...
    public POP3MessageInfo status() throws IOException
    {
        ...
        if (sendCommand(POP3Command.STAT) != org.humbird.soa.common.net.pop3.POP3Reply.OK) {
            return null;
        }
    ...
    public POP3MessageInfo[] listMessages() throws IOException
    {
        ...
        if (sendCommand(POP3Command.LIST) != org.humbird.soa.common.net.pop3.POP3Reply.OK) {
            return null;
        }
        getAdditionalReply();
    ...
    public POP3MessageInfo[] listUniqueIdentifiers() throws IOException
    {
        ...
        if (sendCommand(POP3Command.UIDL) != org.humbird.soa.common.net.pop3.POP3Reply.OK) {
            return null;
        }
        getAdditionalReply();
    ...
    public Reader retrieveMessage(int messageId) throws IOException
    {
        ...
        if (sendCommand(POP3Command.RETR, Integer.toString(messageId)) != org.humbird.soa.common.net.pop3.POP3Reply.OK) {
            return null;
        }
