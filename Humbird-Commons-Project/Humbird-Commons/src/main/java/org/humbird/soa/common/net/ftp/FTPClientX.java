...
import org.humbird.soa.common.net.MalformedServerReplyException;
import org.humbird.soa.common.net.ftp.parser.DefaultFTPFileEntryParserFactory;
import org.humbird.soa.common.net.ftp.parser.FTPFileEntryParserFactory;
import org.humbird.soa.common.net.ftp.parser.MLSxEntryParser;
import org.humbird.soa.common.net.io.*;
 ...
 * from {@link org.humbird.soa.common.net.SocketClient},
 * you must first connect to the server with
 * {@link org.humbird.soa.common.net.SocketClient#connect  connect }
 * before doing anything, and finally
 * {@link org.humbird.soa.common.net.SocketClient#disconnect  disconnect }
 ...
 * {@link org.humbird.soa.common.net.ftp.FTP#getReplyCode  getReplyCode } after
 ...
 * FTPClient uses the {@link org.humbird.soa.common.net.io.ToNetASCIIOutputStream NetASCII}
 ...
 * {@link org.humbird.soa.common.net.ftp.FTPReply#SERVICE_NOT_AVAILABLE FTPReply.SERVICE_NOT_AVAILABLE }
 *  response to a command.
 * When that occurs, the FTP class method encountering that reply will throw
 * an {@link org.humbird.soa.common.net.ftp.FTPConnectionClosedException}
 * .
 ...
 * {@link org.humbird.soa.common.net.ftp.FTPConnectionClosedException}
 ...
 * {@link org.humbird.soa.common.net.ftp.FTP#getReplyCode  getReplyCode },
 * {@link org.humbird.soa.common.net.ftp.FTP#getReplyString  getReplyString },
 * and
 * {@link org.humbird.soa.common.net.ftp.FTP#getReplyStrings  getReplyStrings}.
 ...
 * can also throw a
 * {@link org.humbird.soa.common.net.MalformedServerReplyException}
 * , which is a subclass
 ...
 * from org.humbird.soa.common.net.FTPFileEntryParser:
 * <pre>
 *    FTPClient f = new FTPClient();
 *    f.connect(server);
 *    f.login(username, password);
 ...
 *     as in Ant</li>
 * </ul>see {@link  org.humbird.soa.common.net.ftp.FTPClientConfigX  FTPClientConfig}.
 * <p>
 ...
 * <p>
 * The implementation currently uses a {@link org.humbird.soa.common.net.io.CopyStreamListener} which is passed to the
 * {@link org.humbird.soa.common.net.io.Util#copyStream(java.io.InputStream, java.io.OutputStream, int, long, org.humbird.soa.common.net.io.CopyStreamListener, boolean)}
 ...
 * @see org.humbird.soa.common.net.ftp.FTP
 * @see org.humbird.soa.common.net.ftp.FTPConnectionClosedException
 * @see org.humbird.soa.common.net.ftp.FTPFileEntryParser
 * @see org.humbird.soa.common.net.ftp.parser.FTPFileEntryParserFactory
 * @see org.humbird.soa.common.net.ftp.parser.DefaultFTPFileEntryParserFactory
 * @see org.humbird.soa.common.net.ftp.FTPClientConfigX
 *
 * @see org.humbird.soa.common.net.MalformedServerReplyException
 */
public class FTPClientX extends FTP
implements Configurable
{
     ...
     * @since 3.0
     */
    public static final String FTP_SYSTEM_TYPE = "org.humbird.soa.common.net.ftp.systemType";
     ...
     * @since 3.1
     */
    public static final String FTP_SYSTEM_TYPE_DEFAULT = "org.humbird.soa.common.net.ftp.systemType.default";

    /**
     * The name of an optional systemType properties file ({@value}), which is loaded
     * using {@link Class#getResourceAsStream(String)}.<br/>
     * The entries are the systemType (as determined by {@link org.humbird.soa.common.net.ftp.FTPClientX#getSystemType})
     * and the values are the replacement type or parserClass, which is passed to
     * {@link org.humbird.soa.common.net.ftp.parser.FTPFileEntryParserFactory#createFileEntryParser(String)}.<br/>
     * For example:
     * <pre>
     * Plan 9=Unix
     * OS410=org.humbird.soa.common.net.ftp.parser.OS400FTPEntryParser
     * </pre>
     *
     * @since 3.0
     */
    ...
    private FTPClientConfigX __configuration;
    ...
    private static class PropertiesSingleton {
        ...
        static {
            InputStream resourceAsStream = FTPClientX.class.getResourceAsStream(SYSTEM_TYPE_PROPERTIES);
            Properties p = null;
    ...
    private boolean __storeFile(org.humbird.soa.common.net.ftp.FTPCmd command, String remote, InputStream local)
    throws IOException
    {
    ...
    private OutputStream __storeFileStream(org.humbird.soa.common.net.ftp.FTPCmd command, String remote)
    throws IOException
    {
    ...
    throws IOException
    {
        ...
        return new org.humbird.soa.common.net.io.SocketOutputStream(socket, output);
    }
     ...
     * @deprecated (3.3) Use {@link #_openDataConnection_(org.humbird.soa.common.net.ftp.FTPCmd, String)} instead
     */
    @Deprecated
     ...
     * @since 3.3
     */
    protected Socket _openDataConnection_(org.humbird.soa.common.net.ftp.FTPCmd command, String arg)
    throws IOException
    {
    ...
    throws IOException
    {
        ...
        if (__dataConnectionMode == ACTIVE_LOCAL_DATA_CONNECTION_MODE)
        {
            ...
            try {
                ...
                if (isInet6Address) {
                    if (!org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(eprt(getReportHostAddress(), server.getLocalPort()))) {
                        return null;
                    }
                } else {
                    if (!org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(port(getReportHostAddress(), server.getLocalPort()))) {
                        return null;
                    }
                }
                ...
                if (!org.humbird.soa.common.net.ftp.FTPReply.isPositivePreliminary(sendCommand(command, arg))) {
                    return null;
                }
        ...
        { // We must be in PASSIVE_LOCAL_DATA_CONNECTION_MODE
            ...
            if (attemptEPSV && epsv() == org.humbird.soa.common.net.ftp.FTPReply.ENTERING_EPSV_MODE)
            {
            ...
            else
            {
                ...
                if (pasv() != org.humbird.soa.common.net.ftp.FTPReply.ENTERING_PASSIVE_MODE) {
                    return null;
                }
     ...
     * @exception org.humbird.soa.common.net.ftp.FTPConnectionClosedException
    ...
    public boolean login(String username, String password) throws IOException
    {
        ...
        if (org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(_replyCode)) {
            return true;
        }

        // If we get here, we either have an error code, or an intermmediate
        // reply requesting password.
        if (!org.humbird.soa.common.net.ftp.FTPReply.isPositiveIntermediate(_replyCode)) {
            return false;
        }

        return org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(pass(password));
    }
    ...
    throws IOException
    {
        ...
        return org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(acct(account));
    }
    ...
    {
        return org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(quit());
    }
    ...
    {
        return org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(cwd(pathname));
    }
    ...
    {
        return org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(cdup());
    }
    ...
    {
        return org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(smnt(pathname));
    }
    ...
    boolean reinitialize() throws IOException
    {
        ...
        if (org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(_replyCode) ||
                (org.humbird.soa.common.net.ftp.FTPReply.isPositivePreliminary(_replyCode) &&
                        org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(getReply())))
        {
    ...
    throws IOException
    {
        if (org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(port(host, port)))
        {
    ...
    {
        if (org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(type(fileType)))
        {
            __fileType = fileType;
            __fileFormat = org.humbird.soa.common.net.ftp.FTP.NON_PRINT_TEXT_FORMAT;
            return true;
        }
        return false;
    }
    ...
    throws IOException
    {
        if (org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(type(fileType, formatOrByteSize)))
        {
            __fileType = fileType;
    ...
    {
        if (org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(stru(structure)))
        {
    ...
    {
        if (org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(mode(mode)))
        {
    ...
    public boolean remoteRetrieve(String filename) throws IOException
    {
        if (__dataConnectionMode == ACTIVE_REMOTE_DATA_CONNECTION_MODE ||
                __dataConnectionMode == PASSIVE_REMOTE_DATA_CONNECTION_MODE) {
            return org.humbird.soa.common.net.ftp.FTPReply.isPositivePreliminary(retr(filename));
        }
        return false;
    }
    ...
    public boolean remoteStore(String filename) throws IOException
    {
        if (__dataConnectionMode == ACTIVE_REMOTE_DATA_CONNECTION_MODE ||
                __dataConnectionMode == PASSIVE_REMOTE_DATA_CONNECTION_MODE) {
            return org.humbird.soa.common.net.ftp.FTPReply.isPositivePreliminary(stor(filename));
        }
        return false;
    }
    ...
    public boolean remoteStoreUnique(String filename) throws IOException
    {
        if (__dataConnectionMode == ACTIVE_REMOTE_DATA_CONNECTION_MODE ||
                __dataConnectionMode == PASSIVE_REMOTE_DATA_CONNECTION_MODE) {
            return org.humbird.soa.common.net.ftp.FTPReply.isPositivePreliminary(stou(filename));
        }
        return false;
    }
    ...
    public boolean remoteStoreUnique() throws IOException
    {
        if (__dataConnectionMode == ACTIVE_REMOTE_DATA_CONNECTION_MODE ||
                __dataConnectionMode == PASSIVE_REMOTE_DATA_CONNECTION_MODE) {
            return org.humbird.soa.common.net.ftp.FTPReply.isPositivePreliminary(stou());
        }
        return false;
    }
    ...
    public boolean remoteAppend(String filename) throws IOException
    {
        if (__dataConnectionMode == ACTIVE_REMOTE_DATA_CONNECTION_MODE ||
                __dataConnectionMode == PASSIVE_REMOTE_DATA_CONNECTION_MODE) {
            return org.humbird.soa.common.net.ftp.FTPReply.isPositivePreliminary(appe(filename));
        }
        return false;
    }
    ...
    {
        return org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(getReply());
    }
     ...
     *      to send FTP reply code 421.  This exception may be caught either
     *      as an IOException or independently as itself.
     * @exception org.humbird.soa.common.net.io.CopyStreamException
    ...
    throws IOException
    {
        return _retrieveFile(org.humbird.soa.common.net.ftp.FTPCmd.RETR.getCommand(), remote, local);
    }

    public boolean retrieveFile(String command, String remote, OutputStream local)
            throws IOException
    {
        return _retrieveFile(command, remote, local);
    }
    ...
    {
        return _retrieveFileStream(org.humbird.soa.common.net.ftp.FTPCmd.RETR.getCommand(), remote);
    }
    ...
    throws IOException
    {
        ...
        return new org.humbird.soa.common.net.io.SocketInputStream(socket, input);
    }
    ...
    throws IOException
    {
        return __storeFile(org.humbird.soa.common.net.ftp.FTPCmd.STOR, remote, local);
    }
    ...
    {
        return __storeFileStream(org.humbird.soa.common.net.ftp.FTPCmd.STOR, remote);
    }
    ...
    throws IOException
    {
        return __storeFile(org.humbird.soa.common.net.ftp.FTPCmd.APPE, remote, local);
    }
    ...
    {
        return __storeFileStream(org.humbird.soa.common.net.ftp.FTPCmd.APPE, remote);
    }
    ...
    throws IOException
    {
        return __storeFile(org.humbird.soa.common.net.ftp.FTPCmd.STOU, remote, local);
    }
    ...
    {
        return __storeFileStream(org.humbird.soa.common.net.ftp.FTPCmd.STOU, remote);
    }
    ...
    {
        return __storeFile(org.humbird.soa.common.net.ftp.FTPCmd.STOU, null, local);
    }
    ...
    {
        return __storeFileStream(org.humbird.soa.common.net.ftp.FTPCmd.STOU, null);
    }
    ...
    {
        return org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(allo(bytes));
    }
    ...
    public boolean features() throws IOException {
        return org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(feat());
    }
    ...
    private boolean initFeatureMap() throws IOException {
        if (__featuresMap == null) {
            ...
            boolean success = org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(feat());
    ...
    {
        return org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(allo(bytes, recordSize));
    }
    ...
    {
        return org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(sendCommand(command, params));
    }
    ...
    {
        boolean success = org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(sendCommand(command, params));
        if (success){
     ...
     * @since 3.0
     */
    public org.humbird.soa.common.net.ftp.FTPFile mlistFile(String pathname) throws IOException
    {
        boolean success = org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(sendCommand(org.humbird.soa.common.net.ftp.FTPCmd.MLST, pathname));
        if (success){
     ...
     * @since 3.0
     */
    public org.humbird.soa.common.net.ftp.FTPFile[] mlistDir() throws IOException
    {
    ...
    {
        if (!org.humbird.soa.common.net.ftp.FTPReply.isPositiveIntermediate(rnfr(from))) {
            return false;
        }

        return org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(rnto(to));
    }
    ...
    {
        return org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(abor());
    }
    ...
    {
        return org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(dele(pathname));
    }
    ...
    {
        return org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(rmd(pathname));
    }
    ...
    {
        return org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(mkd(pathname));
    }
    ...
    {
        if (pwd() != org.humbird.soa.common.net.ftp.FTPReply.PATHNAME_CREATED) {
            return null;
        }
    ...
    {
        return org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(site(arguments));
    }
    ...
    public String getSystemType() throws IOException
    {
        ...
        if (__systemName == null){
            if (org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(syst())) {
    ...
    {
        if (org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(help())) {
    ...
    {
        if (org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(help(command))) {
            return getReplyString();
        }
        return null;
    }
    ...
    {
        return org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(noop());
    }
    ...
    {
        Socket socket = _openDataConnection_(org.humbird.soa.common.net.ftp.FTPCmd.NLST, getListArguments(pathname));
     ...
     *                   org.humbird.soa.common.net.ftp.FTPFileEntryParser
     ...
     * @see org.humbird.soa.common.net.ftp.FTPFileEntryParser
     */
    public org.humbird.soa.common.net.ftp.FTPFile[] listFiles(String pathname)
    throws IOException
    {
     ...
     * @see org.humbird.soa.common.net.ftp.FTPFileEntryParser
     */
    public org.humbird.soa.common.net.ftp.FTPFile[] listFiles()
    throws IOException
    {
     ...
     * @since 2.2
     */
    public org.humbird.soa.common.net.ftp.FTPFile[] listFiles(String pathname, FTPFileFilter filter)
    throws IOException
    {
        FTPListParseEngine engine = initiateListParsing((String) null, pathname);
        return engine.getFiles(filter);
    ...
    public int listFiles(FTPCallback ftpCallback)
            throws IOException
    {
        return listFiles((String) null, ftpCallback);
    }

    public int listFiles(String pathname, FTPCallback ftpCallback)
            throws IOException
    {

        return initiateListParsing((String) null, pathname, null, ftpCallback);
    }

    public int listFiles(String pathname, FTPFileFilter filter, FTPCallback ftpCallback)
            throws IOException
    {
        FTPListParseEngine engine = initiateListParsing((String) null, pathname);
        return engine.getFiles(filter, ftpCallback);
    }
     ...
     * @since 3.0
     */
    public org.humbird.soa.common.net.ftp.FTPFile[] listDirectories() throws IOException {
     ...
     * @see org.humbird.soa.common.net.ftp.FTPListParseEngine
     */
    ...
    public int initiateListParsing(
            String parserKey, String pathname, FTPFileFilter filter, FTPCallback callback)
            throws IOException
    {
        // We cache the value to avoid creation of a new object every
        // time a file listing is generated.
        ...
        return initiateListParsing(__entryParser, pathname, filter, callback);
    }

    private int initiateListParsing(
            FTPFileEntryParser parser, String pathname, FTPFileFilter filter, FTPCallback callback)
            throws IOException
    {
        ...
        int count = 0;
        try {
            count = engine.readServerCallback(socket.getInputStream(), getControlEncoding(), filter, callback);
        }
        finally {
            Util.closeQuietly(socket);
        }
    ...
    throws IOException
    {
        Socket socket = _openDataConnection_(org.humbird.soa.common.net.ftp.FTPCmd.LIST, getListArguments(pathname));
    ...
    {
        if (org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(stat())) {
            return getReplyString();
        }
        return null;
    }
    ...
    {
        if (org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(stat(pathname))) {
            return getReplyString();
        }
        return null;
    }
    ...
    public String getModificationTime(String pathname) throws IOException {
        if (org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(mdtm(pathname))) {
            return getReplyString();
        }
        return null;
    }
    ...
    public boolean setModificationTime(String pathname, String timeval) throws IOException {
        return (org.humbird.soa.common.net.ftp.FTPReply.isPositiveCompletion(mfmt(pathname, timeval)));
    }
    ...
    */
    ...
    /**
     * Implementation of the {@link org.humbird.soa.common.net.ftp.Configurable Configurable} interface.
     ...
     * @param config {@link org.humbird.soa.common.net.ftp.FTPClientConfigX FTPClientConfig} object used to
...
//    @Override
    ...
    private static class CSL implements CopyStreamListener {
        ...
        private final FTPClientX parent;
        ...
        CSL(FTPClientX parent, long idleTime, int maxWait) throws SocketException {
            this.idle = idleTime;
            this.parent = parent;
