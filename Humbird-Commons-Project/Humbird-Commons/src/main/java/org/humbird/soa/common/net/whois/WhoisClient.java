...
package org.humbird.soa.common.net.whois;

import org.humbird.soa.common.net.finger.FingerClient;
...
public final class WhoisClient extends FingerClient
{
     ...
     * @exception java.io.IOException  If an I/O error occurs during the operation.
     ***/
