 ...
 */
package org.humbird.soa.common.net.finger;
...
public class FingerClient extends SocketClient
{
     ...
     * @exception java.io.IOException If an I/O error occurs while reading the socket.
     ***/
     ...
     * @exception java.io.IOException If an I/O error during the operation.
     ***/
