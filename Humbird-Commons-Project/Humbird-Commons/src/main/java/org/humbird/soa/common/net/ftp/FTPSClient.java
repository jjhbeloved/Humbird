...
import org.humbird.soa.common.net.util.Base64;
import org.humbird.soa.common.net.util.SSLContextUtils;
import org.humbird.soa.common.net.util.TrustManagerUtils;
 ...
 * @since 2.0
 */
public class FTPSClient extends FTPClientX {
...
//    ftps        990/udp    ftp protocol, control, over TLS/SSL
    ...
    /** The FTPS {@link javax.net.ssl.TrustManager} implementation, default validate only: {@link org.humbird.soa.common.net.util.TrustManagerUtils#getValidateServerCertificateTrustManager()}. */
     ...
     * The default TrustManager is set from {@link org.humbird.soa.common.net.util.TrustManagerUtils#getValidateServerCertificateTrustManager()}
     ...
     * @see org.humbird.soa.common.net.SocketClient#_connectAction_()
     */
    @Override
    ...
    protected void execAUTH() throws SSLException, IOException {
        ...
        if (org.humbird.soa.common.net.ftp.FTPReply.SECURITY_MECHANISM_IS_OK == replyCode) {
            // replyCode = 334
            // I carry out an ADAT command.
        } else if (org.humbird.soa.common.net.ftp.FTPReply.SECURITY_DATA_EXCHANGE_COMPLETE != replyCode) {
    ...
    * @see org.humbird.soa.common.net.util.KeyManagerUtils
    */
    ...
    public void execPBSZ(long pbsz) throws SSLException, IOException {
        ...
        if (org.humbird.soa.common.net.ftp.FTPReply.COMMAND_OK != status) {
            throw new SSLException(getReplyString());
        }
    }
    ...
    public void execPROT(String prot) throws SSLException, IOException {
        ...
        if (org.humbird.soa.common.net.ftp.FTPReply.COMMAND_OK != sendCommand(CMD_PROT, prot)) {
            throw new SSLException(getReplyString());
        }
     ...
     * @see org.humbird.soa.common.net.ftp.FTP#sendCommand(String)
     */
    ...
    public int sendCommand(String command, String args) throws IOException {
        ...
        if (CMD_CCC.equals(command)) {
            if (org.humbird.soa.common.net.ftp.FTPReply.COMMAND_OK == repCode) {
                _socket_.close();
     ...
     * @see org.humbird.soa.common.net.ftp.FTPClientX#_openDataConnection_(int, String)
    ...
    */
     ...
     * @see org.humbird.soa.common.net.util.TrustManagerUtils
     */
