...
public class NTFTPEntryParser extends ConfigurableFTPFileEntryParserImpl
{
     ...
     * @since 1.4
     */
     public NTFTPEntryParser(FTPClientConfigX config)
    {
        super(REGEX);
        configure(config);
        FTPClientConfigX config2 = new FTPClientConfigX(
                FTPClientConfigX.SYST_NT,
...
//    @Override
     ...
     */
    @Override
    public FTPClientConfigX getDefaultConfiguration() {
