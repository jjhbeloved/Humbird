...
package org.humbird.soa.common.net.daytime;
 ...
 * string, then
 * call {@link org.humbird.soa.common.net.SocketClient#disconnect  disconnect }
 * to close the connection properly.
 * @see org.humbird.soa.common.net.daytime.DaytimeUDPClient
 */
public final class DaytimeTCPClient extends SocketClient
{
     ...
     * @exception java.io.IOException  If an error occurs while fetching the time string.
     */
