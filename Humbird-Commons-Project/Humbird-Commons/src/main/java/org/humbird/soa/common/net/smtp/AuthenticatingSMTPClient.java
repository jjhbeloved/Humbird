...
public class AuthenticatingSMTPClient extends SMTPSClient
{
    ...
    {
        return sendCommand(org.humbird.soa.common.net.smtp.SMTPCommand.EHLO, hostname);
    }
    ...
    {
        return org.humbird.soa.common.net.smtp.SMTPReply.isPositiveCompletion(ehlo(hostname));
    }
    ...
    public boolean elogin() throws IOException
    {
        ...
        return org.humbird.soa.common.net.smtp.SMTPReply.isPositiveCompletion(ehlo(name));
    }
     ...
     *
     * @param method the method to use, one of the {@link org.humbird.soa.common.net.smtp.AuthenticatingSMTPClient.AUTH_METHOD} enum values
    ...
    {
        if (!org.humbird.soa.common.net.smtp.SMTPReply.isPositiveIntermediate(sendCommand(SMTPCommand.AUTH,
        ...
        if (method.equals(AUTH_METHOD.PLAIN))
        {
            ...
            return org.humbird.soa.common.net.smtp.SMTPReply.isPositiveCompletion(sendCommand(
        ...
        else if (method.equals(AUTH_METHOD.LOGIN))
        {
            ...
            if (!org.humbird.soa.common.net.smtp.SMTPReply.isPositiveIntermediate(sendCommand(
