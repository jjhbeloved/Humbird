...
public final class TFTPErrorPacket extends TFTPPacket
{
    ...
    {
        super(org.humbird.soa.common.net.tftp.TFTPPacket.ERROR, destination, port);
    ...
    {
        super(org.humbird.soa.common.net.tftp.TFTPPacket.ERROR, datagram.getAddress(), datagram.getPort());
        int index, length;
        byte[] data;
