...
/**
 *
 * Implementation of org.humbird.soa.common.net.SocketFactory
 *
 * @since 2.0
 */
public class FTPSSocketFactory extends SocketFactory {
    ...
    /** @deprecated (2.2) use {@link org.humbird.soa.common.net.ftp.FTPSServerSocketFactory#createServerSocket(int) instead} */
    @Deprecated
    ...
    /** @deprecated  (2.2) use {@link org.humbird.soa.common.net.ftp.FTPSServerSocketFactory#createServerSocket(int, int) instead} */
    @Deprecated
    ...
    /** @deprecated  (2.2) use {@link org.humbird.soa.common.net.ftp.FTPSServerSocketFactory#createServerSocket(int, int, java.net.InetAddress) instead} */
    @Deprecated
    ...
    /** @deprecated  (2.2) use {@link org.humbird.soa.common.net.ftp.FTPSServerSocketFactory#init(java.net.ServerSocket)} */
