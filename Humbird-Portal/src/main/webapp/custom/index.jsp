...
<ul class="nav nav-tabs">
    ...
    <li role="presentation" class="active"><a href="#">Config</a></li>
...
<div class="tab-box">
    ...
    <thead>
        <tr>
            <td style="font-weight: bold;">Folder</td>
            <td style="font-weight: bold;">File</td>
        </tr>
    </thead>
        <c:forEach var="item" items="${maps}">
            <tr><td>${item.value.folder}</td><td><a href="${base.contextPath}${item.value.path}.xhtml">${item.value.file}</a></td></tr>
        </c:forEach>
    </table>
</div>
</body>
